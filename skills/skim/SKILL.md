...
description: >-
  ...
  Uses vertical fact-lines, grouping, nesting, exact-text preservation,
  answer-first ordering, visible action state, evidence-grounded numbers,
  and exact user-controlled expansion. Use when the user says "skim",
  "/skim on", or asks for dense vertical output. Remains active until
  "/skim off" or "normal mode".
---
